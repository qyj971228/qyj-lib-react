...
export function getButtonSize(size?: size) {
  return size
    ? {
        ...
        padding: `${sizeMagnification[size] * 5}px` + ` ` + `${sizeMagnification[size] * 10}px`
      }
    : {}
}
...
export const defaultButtonStyles: CSSObject = {
  ...
  '&:active': {
    filter: 'brightness(1.3)',
    boxShadow: 'rgb(0 0 0 / 6%) 0px 4px 2px -2px, rgb(0 0 0 / 24%) 0px 4px 4px 0px, rgb(0 0 0 / 22%) 0px 3px 7px 0px'
  }
}
